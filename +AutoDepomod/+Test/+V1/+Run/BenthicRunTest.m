...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods(TestMethodSetup)
        function setup(testCase)
            ...
            testCase.Run = AutoDepomod.V1.Run.Benthic(testCase.Project, 'Gorsten-BcnstFI-N-1.cfg');
        end
    end
    ...
    methods (Test)
        ...
        function testFileNameRunNumberParse(testCase)
            ...
            verifyEqual(testCase, AutoDepomod.V1.Run.Base.parseRunNumber(filePath), '2');
            
            filePath = 'Gorsten-BcnstFI-N-19.cfg'; % double digit
            verifyEqual(testCase, AutoDepomod.V1.Run.Base.parseRunNumber(filePath), '19');
            
            filePath = 'Gorsten-BcnstFI-N-109.cfg'; % triple digit
            verifyEqual(testCase, AutoDepomod.V1.Run.Base.parseRunNumber(filePath), '109');
        end
