classdef LayoutTest < matlab.unittest.TestCase
    ...
    methods(TestMethodSetup)
        function setup(testCase)
            ...
            testCase.Run = testCase.Project.solidsRuns.number(243);
            testCase.Site = Depomod.Layout.Site.fromXMLFile(testCase.Run.cagesPath);
        end
    end
    ...
    methods (Test)
        ...
        function testSiteClass(testCase)
           verifyEqual(testCase, class(testCase.Site), 'Depomod.Layout.Site'); 
        end
        ...
        function testGroupClass(testCase)
            verifyEqual(testCase, class(testCase.Site.cageGroups{1}), 'Depomod.Layout.Cage.Group'); 
        end
        ...
        function testCageClass(testCase)
            ...
            verifyEqual(testCase, class(cageA), 'Depomod.Layout.Cage.Circle');
            verifyEqual(testCase, class(cageB), 'Depomod.Layout.Cage.Circle'); 
        end
