classdef TimeSeriesTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testBasicConstructor(testCase)
            timeSeries = NewDepomod.Currents.TimeSeries([],[],[]);
          
            verifyEqual(testCase, class(timeSeries), 'NewDepomod.Currents.TimeSeries');
        ...
        function testFileConstructor(testCase)
            timeSeries = NewDepomod.Currents.TimeSeries.fromFile(testCase.Path);
