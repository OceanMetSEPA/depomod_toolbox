classdef TimeSeriesTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testBasicConstructor(testCase)
            timeSeries = AutoDepomod.V1.Currents.TimeSeries([],[],[]);
          
            verifyEqual(testCase, class(timeSeries), 'AutoDepomod.V1.Currents.TimeSeries');
        ...
        function testFileConstructorSNS(testCase)
            % SNS
            timeSeries = AutoDepomod.V1.Currents.TimeSeries.fromFile(testCase.Path);
