classdef ProjectTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testBenthicLogPath(testCase)
            actSolution = testCase.Project.logFilePath('B');
        ...
        function testSNSCurrents(testCase)
            ...
            verifyEqual(testCase, class(SNSCurrents), 'AutoDepomod.V1.Currents.Profile');
        ...
        function testNSNCurrents(testCase)
            ...
            verifyEqual(testCase, class(NSNCurrents), 'AutoDepomod.V1.Currents.Profile');
