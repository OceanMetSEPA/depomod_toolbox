classdef LayoutTest < matlab.unittest.TestCase
    ...
    methods(TestMethodSetup)
        function setup(testCase)
            ...
            testCase.Run = testCase.Project.solidsRuns.number(1);
            testCase.Site = Depomod.Layout.Site.fromCSV(testCase.Run.cagesPath);
        end
    end
    ...
    methods (Test)
        ...
        function testCageClass(testCase)
            ...
            verifyEqual(testCase, class(cageA), 'Depomod.Layout.Cage.Square');
            verifyEqual(testCase, class(cageB), 'Depomod.Layout.Cage.Square'); 
        end
