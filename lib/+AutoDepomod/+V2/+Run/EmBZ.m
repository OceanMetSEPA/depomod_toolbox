classdef EmBZ < AutoDepomod.V2.Run.Chemical
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% $Workfile:   EmBZ.m  $
% $Revision:   1.5  $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods      
        ...
        function p = prnPath(EBR, index)
            ...
            p = strcat(EBR.project.intermediatePath, '\', EBR.configFileRoot, ['-consolidated-g', num2str(index), '.depomodtimeseries']);
        end
        ...
        function p = initializePrn(EBR, index)            
            if exist(EBR.prnPath(index), 'file') == 2
                p = AutoDepomod.TimeSeries.createFromTimeSeriesFile(EBR.prnPath(index), 4); % column 4 in depomodtimeseries file
            else
                p = [];
