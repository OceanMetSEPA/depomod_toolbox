classdef TimeSeries < AutoDepomod.Currents.TimeSeries
    ...
    methods (Static = true)
        ...
        function [sns, nsn] = fromFile(datFile)
            ...
            % Convert cm/s to m/s
            sns = AutoDepomod.V1.Currents.TimeSeries(double(data{4}), data{5}./100.0, data{6}, 'isSNS', 1, constructorArgs{:});
            nsn = AutoDepomod.V1.Currents.TimeSeries(double(data{1}), data{2}./100.0, data{3}, 'isSNS', 0, constructorArgs{:});            
        end
