classdef LogFile
    ...
    methods
        function LF = LogFile(path)
            ...
            rows = AutoDepomod.FileUtils.readTxtFile(path);% read the log file
        ...
        function str = run(LF, runNumber)
            ...
            for column = 1:size(runData, 2)   
                ...
                value = AutoDepomod.V1.LogFile.castValue(runData{1,column});  
                str.(AutoDepomod.V1.LogFile.formatHeader(LF.table{1,column})) = value;
            end
        end
