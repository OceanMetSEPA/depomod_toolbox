classdef ITITest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testFromFluxFarField(testCase)
            actSolution = Depomod.ITI.fromFlux(191.8);
        ...
        function testFromFluxNearField(testCase)
            actSolution = Depomod.ITI.fromFlux(1561);
        ...
        function testFromFluxUpperBound(testCase)
            actSolution = Depomod.ITI.fromFlux(10000);
            expSolution = 1; 
        ...
        function testFromFluxAboveDomain(testCase)
            actSolution = Depomod.ITI.fromFlux(10000000);
            expSolution = 1; 
        ...
        function testFromFluxBelowDomain(testCase)
            actSolution = Depomod.ITI.fromFlux(-1);
            expSolution = NaN; 
        ...
        function testFromFluxLowerBound(testCase)
            actSolution = Depomod.ITI.fromFlux(0);
            expSolution = 59; 
        ...
        function testToFluxFarField(testCase)
            actSolution = Depomod.ITI.toFlux(30);
        ...
        function testToFluxNearField(testCase)
            actSolution = Depomod.ITI.toFlux(10);
        ...
        function testToFluxAboveDomain(testCase)
            actSolution = Depomod.ITI.toFlux(60);
            expSolution = 0; 
        ...
        function testToFluxUpperBound(testCase)
            actSolution = Depomod.ITI.toFlux(59);
            expSolution = 0; 
        ...
        function testToFluxLowerBound(testCase)
            actSolution = Depomod.ITI.toFlux(1);
            expSolution = 10000; 
