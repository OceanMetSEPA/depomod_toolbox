...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%A=importdata(fileName,',',1); % Original load method- slow!

% Read header- probably don't need to do this as it's probably unchanging
fid=fopen(fileName);
colheaders=fgetl(fid);
fclose(fid);
% Now read the data:
A.data=dlmread(fileName,',',1,0);
A.colheaders=strsplit(colheaders,',');
